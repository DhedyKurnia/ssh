...
wget -O /etc/accel-ppp.conf "https://raw.githubusercontent.com/DhedyKurnia/ssh/main/accel.conf"
...
#input perintah sstp
wget -O /usr/bin/add-sstp https://raw.githubusercontent.com/DhedyKurnia/ssh/main/add-sstp.sh && chmod +x /usr/bin/add-sstp
wget -O /usr/bin/del-sstp https://raw.githubusercontent.com/DhedyKurnia/ssh/main/del-sstp.sh && chmod +x /usr/bin/del-sstp
wget -O /usr/bin/check-sstp https://raw.githubusercontent.com/DhedyKurnia/ssh/main/check-sstp.sh && chmod +x /usr/bin/check-sstp
wget -O /usr/bin/renew-sstp https://raw.githubusercontent.com/DhedyKurnia/ssh/main/renew-sstp.sh && chmod +x /usr/bin/renew-sstp
rm -f /root/sstp.sh
