...
cd /usr/bin
wget -O add-ss "https://raw.githubusercontent.com/DhedyKurnia/ssh/main/add-ss.sh"
wget -O del-ss "https://raw.githubusercontent.com/DhedyKurnia/ssh/main/del-ss.sh"
wget -O check-ss "https://raw.githubusercontent.com/DhedyKurnia/ssh/main/check-ss.sh"
wget -O renew-ss "https://raw.githubusercontent.com/DhedyKurnia/ssh/main/renew-ss.sh"
chmod +x add-ss
chmod +x del-ss
chmod +x check-ss
chmod +x renew-ss
